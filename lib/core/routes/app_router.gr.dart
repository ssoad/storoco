...
class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    BottomNavSetting.name: (routeData) {
      return AdaptivePage<dynamic>(
        routeData: routeData,
        child: const BottomNavSettingView(),
      );
    },
    ...
    NicknameCreator.name: (routeData) {
      return AdaptivePage<dynamic>(
        routeData: routeData,
        child: const NicknameCreatorView(),
      );
    },
    ...
    SoundList.name: (routeData) {
      return AdaptivePage<dynamic>(
        routeData: routeData,
        child: const SoundListView(),
      );
    },
    StoryPadRestore.name: (routeData) {
      return AdaptivePage<dynamic>(
        routeData: routeData,
        child: const StoryPadRestoreView(),
      );
    },
    ThemeSetting.name: (routeData) {
      return AdaptivePage<dynamic>(
        routeData: routeData,
        child: const ThemeSettingView(),
      );
    },
    User.name: (routeData) {
      return AdaptivePage<dynamic>(
  ...
  ChangesHistory({
    ...
    required void Function(
      ...
      StoryDbModel,
        ...
        onRestorePressed,
    required Future<StoryDbModel> Function(
      List<int>,
      StoryDbModel,
    )
        onDeletePressed,
...
class ChangesHistoryArgs {
  ...
  final Future<StoryDbModel> Function(
    List<int>,
    StoryDbModel,
  ) onDeletePressed;
...
class BackupHistoriesManager extends PageRouteInfo<BackupHistoriesManagerArgs> {
  BackupHistoriesManager({
    ...
    required BaseBackupDestination<BaseCloudProvider> destination,
          ...
          BackupHistoriesManager.name,
          path: 'backup-histories-manager',
          args: BackupHistoriesManagerArgs(
            key: key,
            destination: destination,
          ),
        );
...
class BackupHistoriesManagerArgs {
  const BackupHistoriesManagerArgs({
    this.key,
    required this.destination,
  });
